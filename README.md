...
This is my personal dotfiles in a structure inspired by [Rosco Kalis](https://github.com/rkalis/dotfiles)
...
3. Clone this repository
  ```bash
  git clone git@github.com:marcelotokarnia/dotfiles.git
  ```
...
* functions/
  ...
  * fish_prompt_right.fish - Right prompt with date and execution time
